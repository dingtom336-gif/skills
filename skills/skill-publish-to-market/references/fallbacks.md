...
## Case 0: curl Not Available

**Detection:** `curl --version` returns error
**Recovery:** Inform user curl is required. On most systems it's pre-installed. If not:
- macOS: `brew install curl`
- Ubuntu: `sudo apt install curl`
- Alpine: `apk add curl`

**NEVER simulate curl output. If curl is unavailable, STOP.**
